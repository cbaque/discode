...
export class HomeoneComponent implements OnInit, AfterViewChecked{
   ...
   public getFeaturedProducts() {
      ...
      this.prodSrv.getProductossCliente().subscribe( res => { this.productsArray = res; } );
   }
   ...
   public onFeaturedSelectedTab(tabIndex) {
      ...
      switch (tabIndex) {
         case 0:
            this.productsSliderData = this.productsArray.CODIFICADO;
         break;

         case 1:
            this.productsSliderData = this.productsArray.SUMINISTRO;
         break;

         case 2:
            this.productsSliderData = this.productsArray.TEXTIL;
         break;

         case 3:
            this.productsSliderData = this.productsArray.ENVASE;
         break;
         default:
            // code...
            break;
